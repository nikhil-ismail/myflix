...
const Search = (props) => {
  ...
  return (
    <Flex backgroundColor="#DEB992" flexDirection="column" ml="30px" mr="30px" padding="25px" borderRadius="10px">
        <Heading color="#051622" fontSize="26px" mb="15px">Search {props.title}</Heading>
