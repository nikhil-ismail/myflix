...
const Results = (props) => {
  ...
  return (
    <Flex width="440px" backgroundColor="#c4cfce" flexDirection="column" mt="10px" ml="30px" padding="25px" borderRadius="10px">
      ...
      {results.length === 0 || query === "" ? (
        ...
        <Flex flexDirection="column">
          ...
          {results.length < 3 ? <Flex></Flex> : more ? (
            <Button ml="65px" width="250px" onClick={handleShowMore}>Show Less</Button>
          ) : (
              <Button ml="65px" width="250px" onClick={handleShowMore}>Show More</Button>
            )
          }
        </Flex>
      )}
